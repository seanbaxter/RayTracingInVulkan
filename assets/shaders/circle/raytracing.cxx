...
int main() {
#if GEN_RINT_SPHERE
  // Due to a bug in the NVIDIA Vulkan driver, putting the rint and 
  // rchit shaders into the same module breaks the execution of the rint 
  // shader. For now, compiler offline and separate.
  @spirv(rint_sphere);
